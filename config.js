...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("Raganork~ce5be765bcecac5df2d8e588d20b0f49:363565456731664d5578733d")
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "Hey {sender}, I'm alive {uptime}",
    ...
    AUTO_READ_STATUS: convertToBool(process.env.AUTO_READ_STATUS) || truee,
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~a6684232d27ddc0bbe43ad943fac9fc3:76776965534138614c544d3d',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'ᴉᴛᴢ ᴍᴇ ᴀᴅᴋ_ʀᴉᴄʜᴜ;ADK 리츄;916282122603;https://telegra.ph/file/42d9cf926fb1eb8d10255.jpg;https://chat.whatsapp.com/I9WpnuNlTj8ELutpU4qfl7',
